...
**Current Focus:**
*   **[Synkti](https://github.com/bobby-math/synkti)**: Domain-agnostic orchestration for spot instances using Kuhn-Munkres optimal migration and grace-period checkpoint recovery.
*   **Axon**: Distributed neuron execution runtime.
*   **Synapse**: Inter-node communication layer for decentralized inference.
